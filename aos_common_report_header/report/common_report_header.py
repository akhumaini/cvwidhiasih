...
#         # Prepare initial sql query and Get the initial move lines
#         if init_balance:
#             init_tables, init_where_clause, init_where_params = MoveLine.with_context(date_from=context.get('date_from'), date_to=False, initial_bal=True)._query_get()#MoveLine.with_context(date_to=self.context.get('date_from'), date_from=False)._query_get()
